    ...
    customElements.define('com-sap-estilos-doubledonut', class HelloWorld extends HTMLElement {
        ...
        connectedCallback(){
            if (this._firstConnection) {
                this.innerHTML('<link data-require="normalize@*" data-semver="3.0.1" rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/normalize/3.0.1/normalize.min.css" />');
                this.innerHTML('<script src="https://cdnjs.cloudflare.com/ajax/libs/d3/3.4.6/d3.min.js" data-semver="3.4.6" data-require="d3@*"></script>')
            }
